...
const floorDisplacementTexture = textureLoader.load('./floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_dis_1k.webp')

// repeating texture, higher value means smaller repeating pattern
...
for (let i = 0; i < 30; i++)
    {
        ...
        // adding grave randomness outside of house (+3)
